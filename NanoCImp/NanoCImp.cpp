				...
				case 1://Http
				{
						   ...
						   for (int i = 0; url[i]; i++) {
							...
							if (CharString::match(url, "/socket.io/1/websocket/96e1cc6b-b2c7-4372-967f-172b3f9a2a99")) {
								...
								//返回http信息
								CharString::encodeFrame(charString->str, CharString::WS_FrameType::WS_TEXT_FRAME, "1::");
